...
const ATLANTA_CATEGORIES = [
  ...
  ['sausages', '香肠', '🌭', '#8A5140', '按鸡肉、牛肉、猪肉、培根和法兰克福等类型细分。'],
  ['deli_meat', '冷切与肉片', '🥪', '#8A5140', '火腿、火鸡片、pepperoni 和肉条按形态显示。'],
  ['prepared_meat', '肉类制成品', '🍖', '#8A5140', '熟制、裹粉、肉丸和三明治类肉制品。'],
  ...
  ['cheese', '奶酪', '🧀', '#91702A', '切片、刨丝、分装和块状奶酪按形态显示。'],
  ...
  ['sauces_condiments', '酱料与佐料', '🥫', '#8A5A24', '番茄酱、蛋黄酱、芥末和其他酱料分开。'],
  ['cooking_oils', '食用油', '🫒', '#8A6F24', '橄榄油、菜籽油和其他食用油分开。'],
  ['canned_pickled', '罐头与腌渍食品', '🫙', '#7A602A', '番茄罐头、豆罐头和腌菜分别显示。'],
